...
class DevelopmentConfig(Config):
    ...
    # SQLAlchemy settings
    SQLALCHEMY_DATABASE_URI = 'sqlite:////Users/darshangadkari/Documents/DGBMICalculator/db.sqlite'
